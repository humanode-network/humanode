...
impl pallet_balances::Config for Runtime {
    ...
    /// `1` allows an account to be ripped, but does not allow and loss of funds, i.e. you can't
    ...
    /// For the record, existatial deposit of `0` will prevent account ripping altogether, enabling
