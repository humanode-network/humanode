...
const codeModes = {
  ...
  runBenchmark: {
    ...
    cargoCommand: "run",
    cargoArgs: "--features runtime-benchmarks benchmark pallet --chain benchmark --execution wasm --wasm-execution compiled --heap-pages 4096 --pallet '*' --extrinsic '*' --steps 1 --repeat 1",
