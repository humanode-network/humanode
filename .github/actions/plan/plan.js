...
const codeModes = {
  ...
  runBenchmark: {
    ...
    cargoCommand: "run",
    cargoArgs: "--features runtime-benchmarks benchmark pallet --chain benchmark --execution wasm --wasm-execution compiled --db-cache 2048 --no-verify --pallet '*' --extrinsic '*' --steps 1 --repeat 1",
