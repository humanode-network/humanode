...
const codeModes = {
  ...
  runBenchmark: {
    ...
    cargoCommand: "run",
    cargoArgs: "--features runtime-benchmarks,wasmtime benchmark pallet --chain benchmark --execution wasm --wasm-execution compiled --pallet '*' --extrinsic '*' --steps 1 --repeat 1",
