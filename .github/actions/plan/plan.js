...
const codeModes = {
  ...
  runBenchmark: {
    ...
    cargoCommand: "run",
    cargoArgs: "--release --features runtime-benchmarks,wasmtime benchmark pallet --chain benchmark --execution native --pallet '*' --extrinsic '*' --steps 1 --repeat 0 --no-verify --external-repeat 0",
